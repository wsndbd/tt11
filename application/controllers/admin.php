...
class Admin extends CI_Controller {
	 ...
	 * @param string $parentid 可选的参数
	 */
	public function themeadd($parentid = '0') {
...
//		$render_data = array('data' => $resp->getData());
		$this->load->view('admin/include_header');
		$this->load->view('admin/themeadd_view');
	}
	...
	public function themeupdate_op() {

		$this->M_theme->update_theme();
		$data[ 'theme_saved' ] = TRUE;
		$data[ 'theme' ]       = $this->M_theme->get_all_theme();
		$this->load->view('admin/include_header');
		$this->load->view('admin/theme_view', $data);
	}
	public function themeadd_op() {
//		var_dump($_POST);die;
		$this->M_theme->add_theme();
		$data[ 'theme' ]       = $this->M_theme->get_all_theme();
		$data[ 'theme_saved' ] = FALSE;
		$this->load->view('admin/include_header');
		$this->load->view('admin/theme_view', $data);
	 ...
	 *
	 */
	public function themedelete($theme_id) {

		$this->M_theme->delete_theme($theme_id);
		$data[ 'theme' ]       = $this->M_theme->get_all_theme();
		$data[ 'theme_saved' ] = TRUE;
		$this->load->view('admin/include_header');
		$this->load->view('admin/theme_view', $data);
